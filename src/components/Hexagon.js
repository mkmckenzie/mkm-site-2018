...
function Hexagon({ sizeMultiplier, backgroundColor, image }) {
	...
	<div className='wholeHexagon'>
		...
		<div className="polygon-each-img-wrap">
			<img src={image} alt="Mary Katherine in Granada with the sun setting in the background and a glass of rose on the table." className="polygon-clip-hexagon" style={imgStyle} />
		</div>
	</div>;
