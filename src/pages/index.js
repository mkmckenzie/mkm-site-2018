...
function IndexPage() {
  return (
    <TemplateWrapper>
      ...
      <div id="summary" style={containerStyle}>
        <Summary />
      </div>
      <div id="skills" style={containerStyle}>
        <Skills content={SkillContent} title="Skills" />
      </div>
      <div id="work-history" style={containerStyle}>
        <WorkHistory content={WorkHistoryContent} title="Work History" />
      </div>
      <div id="community-leadership" style={containerStyle}>
        <WorkHistory
          content={VolunteerHistoryContent}
          title="Community Leadership"
        />
      </div>
      <div id="education" style={containerStyle}>
        <WorkHistory content={EducationContent} title="Education" />
      </div>
      <div id="media-mentions" style={containerStyle}>
        <Skills content={MediaContent} title="Media Mentions" />
      </div>
      <div id="projects-presentations" style={containerStyle}>
        <Skills
