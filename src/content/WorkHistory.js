...
const WorkHistoryContent = [
														{
															...
															description: <ul>
																<li>Stack: Rails, React, PostgreSQL, GraphQL, TypeScript, Coming Soon: Redux</li>
																<li>Projects: TBD!</li>
																<li>Daily: TBD! Likely a continuation of daily duties from previous role, with an emphasis on mentorship and gaining technical expertise. </li>
															</ul>,
															order: 1,
														},
														{
