...
const SkillsContent	=	[
									...
									},
									{
										...
										<ul>
											...
											<li>Attended <a href="http://rubyforgood.org/">Ruby for Good</a> 
												<ul>
													<li>2016: <a href="https://github.com/rubyforgood/scimitar_oryx/pulls?q=is%3Apr+is%3Aclosed+author%3Amkmckenzie">Scimitar Oryx project</a></li>
													<li>2017: Operation Code project</li>
													<li>2019: <a href="https://github.com/Terrastories/terrastories/pulls?q=is%3Apr+is%3Aclosed+author%3Amkmckenzie">Terristories project</a></li>
												</ul>
											</li>
											<li>Co-organized <a href="https://rubybythebay.org//">Ruby by the Bay</a> 2020 (remote!)</li>
										</ul>,
										flex: '1',
										key: 2,
									},
									...
									},
									{
										...
										skillDescription: <div style={{ textAlign: 'center', marginBottom: '10px', }}> GraphQL, Typescript, HTML5/CSS3, PostgreSQL, Sass, Elasticsearch, MySQL, Adobe Illustrator, Generally Being a Good Person </div>,
										flex: '100%',
										key: 4,
									},
								];
