...
const VolunteerHistoryContent = [
	{
		...
		description:
				<ul>
					...
					<li>Coordinate efforts to pivot event from on-site to remote due to COVID-19</li>
					<li>Act as team shepherd for the <a href="https://github.com/rubyforgood/freeforest">Free Forest School project</a></li>
	...
	},
	{
		...
		description:
				<ul> 
					...
					<li>Volunteered at <a href="http://codelandconf.com/">Codeland</a> 2017 and 2018, the 2-day annual CodeNewbie conference, in NYC</li>
				</ul>
		,
		order: 3
	},
